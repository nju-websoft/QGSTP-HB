...
public class DBbuilder extends ProcessBase {
    ...
    SQL_batch nodes,edges,keyword,keymap,queries;

    /**
     * Create the experiment database, and initialize the tables: nodes, edges, keyword, keymap, queries
    ...
    DBbuilder(String dbname){
        ...
        try{
            ...
            // create tables: nodes, edges, keyword, keymap, labels_list
            stmt.executeUpdate(
                            "create table nodes(" +
                            "    `id` int not null," +
                            "    `name` varchar(1024)," +
